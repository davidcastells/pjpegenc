...
// We eliminte the components matrices, instead we work with the original
// RGB data and convert it to YCrCb as needed
...
public:
     ...
     * input image.
     */
        void getYCrCb(int comp, int y, int x, float dctArray1[8][8]);
