...
// ensure they start with values larger than will actually be the case.
        ...
        for (r = 0; r < MinBlockHeight; r++)
        {
           for (c = 0; c < MinBlockWidth; c++)
           {
               ...
               ypos = r*8;
                    ...
                    dct.quantizeBlock(dctArray2->get3DRef(comp, r, c), JpegObj->QtableNumber[comp], dctArray3->get3DRef(comp, r, c));
               }
           }
        }
        ...
        for (r = 0; r < MinBlockHeight; r++)
        {
           for (c = 0; c < MinBlockWidth; c++)
           {
               ...
               for (comp = 0; comp < NUMBER_OF_COMPONENTS; comp++)
               {
                    Huf.run(outStream, dctArray3->get3DRef(comp, r, c), lastDCvalue[comp], JpegObj->DCtableNumber[comp], JpegObj->ACtableNumber[comp], false);
                    lastDCvalue[comp] = dctArray3->get(comp, r, c, 0, 0);                     
               }
            }
        }
